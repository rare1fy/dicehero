...
> **专题引用**：战斗爽点两大核心 UI —— **伤害演出 4 Phase 编排** + **遗物半弹窗自动展开/刷光**，详见独立专题 [`08-damage-settlement-relic-drawer.md`](./08-damage-settlement-relic-drawer.md)。该章节的结算流程、遗物刷光时序、伤害数字三档字号、卡肉震屏三档参数等均在 08 文档中完整描述，本章不再重复。
