...
## v2.0 · 设计修正落地（2026-04-27）

刘叔第 2 轮审阅后提出 6 条核心修正，已全部落地到源文档：

| # | 修正 | 落地位置 |
|---|---|---|
| 1 | 篝火：回血 / 净化骰子二选一（非升级遗物）| Part3 §16.2 |
| 2 | 宝箱：新小玩法（保留原基础形式说明）| Part3 §16.4 |
| 3 | skillSelect 阶段 / 增幅模块删除 | Part1 §1.1 §1.2 / Part3 §18.7 |
| 4 | 战利品 4 档分级（普通 / 精英 / 中 Boss / 终极 Boss）| Part3 §16.5 + Checklist §21.8 |
| 5 | 盗贼初始普通骰 3 → 4 | Part1 §3.1 |
| 6 | 骰子升级机制搁置（标注待办）| Part2 §11.7 + Part3 §16.2 |

此外补充了 11 处"体验定位"自然语言序言（三职业 / 敌人 / 骰子 / 遗物 / 牌型 / 状态 / 挑战 / 节点 / 灵魂晶 / UI / 边界），避免"只用程序描述"。
