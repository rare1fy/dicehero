...
export const BOSS_ENEMIES: EnemyConfig[] = [
  // 章1 中Boss
  {
    ...
    quotes: {
      ...
      death: ['我的……灵魂宝石……不——！', '这不可能……巫妖……不灭的……', '千年的亡灵契约……断了……', '不……你以为这就结束了？（笑声渐远）'],
      attack: ['亡灵风暴！', '骸骨之矛！', '让亡灵大军吞噬你！'],
      hurt: ['灵魂宝石……动摇了……', '你……竟能伤到我？'],
      lowHp: ['灵魂宝石……碎裂吧——释放一切死灵之力！', '骸骨之墙，给我立起来！', '我的亡灵大军……全部听令！'],
    },
  },
  // 章1 终Boss
  {
    ...
    quotes: {
      ...
      death: ['森林……终将……重生……', '你……是第一个……砍倒我的人……', '根须……回归大地……', '下一轮的春天……不再属于我……'],
      attack: ['大地之怒！', '根须绞杀！', '千年之力！'],
      hurt: ['不过是……树皮划痕……', '千年巨木……岂会轻倒？'],
      lowHp: ['大地啊……赐予我……最后的力量——！', '千年巨木，岂会倒于你手！', '根须！缠住他！'],
    },
  },
  // 章2 中Boss
  {
    ...
    quotes: {
      ...
      death: ['寒冬……永远……不会结束……', '（冰雕碎裂）', '王冠……坠地……', '我的冰封之国……终究……融化了……'],
      attack: ['暴风雪！', '冰封！', '寒冰王冠之力！'],
      hurt: ['我的冰甲……裂了？', '温暖……好恶心……'],
      lowHp: ['冰封……整个世界吧——！', '血液都要冻结了吗？可笑！', '我的宫殿，还不倒塌！'],
    },
  },
  // 章2 终Boss
  {
    ...
    quotes: {
      ...
      death: ['不……霜之哀伤……不会……', '永恒的寒冬……终结了？', '王座……崩塌了……', '巫妖王……也会死？……荒谬……'],
      attack: ['霜之哀伤！', '臣服于寒冰！', '灵魂收割！'],
      hurt: ['不过是……暖风拂面。', '你的抵抗……毫无意义。'],
      lowHp: ['所有人……都将臣服于寒冰王座——！', '死亡，并不是终结！', '霜之哀伤，喝饱他的灵魂！'],
    },
  },
  // 章3 中Boss
  {
    ...
    quotes: {
      ...
      death: ['不——！岩浆……在退却……', '我会……回来的……', '炎魔不死……只是沉睡……', '这把锤子……也冷却了吗……'],
      attack: ['岩浆之锤！', '烈焰冲击！', '燃烧吧——！'],
      hurt: ['渣渣！你敢伤我？', '这点伤……不算什么！'],
      lowHp: ['烈焰……最后的爆发——焚尽一切！', '燃烧！继续燃烧！', '炎魔之怒，连熔岩都要沸腾！'],
    },
  },
  // 章3 终Boss
  {
    ...
    quotes: {
      ...
      death: ['不……我是……大地的毁灭者……怎么会……', '（咆哮着坠入岩浆）', '鳞片……在剥落……', '大灾变……就止步于此了吗……'],
      attack: ['大灾变！', '熔岩吐息！', '世界……在燃烧！'],
      hurt: ['你伤到了……我的钢铁之躯？', '可笑……'],
      lowHp: ['即使我倒下……世界……也已面目全非——！', '用我的血，灌溉这片焦土！', '大地龟裂吧！与我同毁！'],
    },
  },
  // 章4 中Boss
  {
    ...
    quotes: {
      ...
      death: ['不……军团……不会……', '我会……在扭曲虚空中……重生！', '燃烧军团……停止征伐……？', '虚空……也会抛弃我吗……'],
      attack: ['暗影之手！', '邪能风暴！', '毁灭一切！'],
      hurt: ['你……竟敢？', '渺小的虫子……'],
      lowHp: ['燃烧吧——用你的世界……作为我的燃料！', '军团，降临！', '邪能，流入我的血脉吧！'],
    },
  },
  // 章4 终Boss
  {
    ...
    quotes: {
      ...
      death: ['虚空……会记住……这一天……', '不可能……欺骗者……怎会被欺骗……', '这竟然……不是幻象……', '我的布局……竟在此崩塌……'],
      attack: ['黑暗终焉！', '邪能陨石！', '所有生命——终结吧！'],
      hurt: ['有趣……你确实……有些能耐。', '欺骗者……不惧伤痛。'],
      lowHp: ['用虚空的全部力量——毁灭这个世界！', '你走进的，是更深的陷阱！', '扭曲虚空，打开吧！'],
    },
  },
  // 章5 中Boss
  {
    ...
    quotes: {
      ...
      death: ['秩序……被打破了……', '报告……泰坦……入侵者……无法阻止……', '运行异常……核心……离线……', '这……不符合……预测……'],
      attack: ['泰坦审判！', '秩序之光！', '修正错误！'],
      hurt: ['损伤……在可控范围内……', '你的力量……超出预期……'],
      lowHp: ['启动……最终审判协议——！', '战斗协议升级：毁灭模式。', '修正：消灭威胁优先级——最高。'],
    },
  },
  // 章5 终Boss
  {
    ...
    quotes: {
      ...
      death: ['不……不可能……永恒……怎么会……', '你……究竟……是什么？……永恒……也有尽头……', '永恒的谎言……终被戳破……', '骰子掷者……你赢了……这一次……'],
      attack: ['终极之光！', '永恒之力，碾碎你！', '渺小者，跪下！'],
      hurt: ['哼……有点意思。', '永恒之躯……竟被撼动……'],
      lowHp: ['永恒……动摇了……但我绝不会……就此终结！终极之光——爆发！', '时间之外的力量——听我号令！', '我的存在即永恒，何谈倒下！'],
    },
  },
];
