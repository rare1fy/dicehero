...
export const STATUS_INFO: Record<StatusType, {
  ...
  vulnerable: { icon: <PixelCrackedHeart size={2} />, color: 'text-orange-400', colorRgb: 'rgb(251,146,60)', bgColor: 'rgba(251,146,60,0.18)', borderColor: 'rgba(251,146,60,0.55)', label: '易伤', description: '受到的伤害增加 50%。每回合结束 -1 层。' },
