 ...
 * [2026-05-08] 一颗橙红色心脏，中间贯穿一道闪电状深色裂纹，
 *             左半亮色/右半暗色，强调\"已破碎\"的不对称感。
 *   主色:  #e67a2a（亮橙）   暗色: #8b3a0a（深焦橙）
 *   裂纹:  #2a1008（近黑）   高光: #ffb070
 */
export const CRACKED_HEART: readonly (readonly string[])[] = [
  ['',         '#e67a2a', '#e67a2a', '',         '#8b3a0a', '#8b3a0a', ''        ],
  ['#e67a2a', '#ffb070', '#2a1008', '#e67a2a', '#2a1008', '#8b5a1a', '#8b3a0a'],
  ['#e67a2a', '#ffb070', '#e67a2a', '#2a1008', '#8b5a1a', '#8b5a1a', '#8b3a0a'],
  ['#e67a2a', '#e67a2a', '#2a1008', '#8b5a1a', '#2a1008', '#8b5a1a', '#8b3a0a'],
  ['',         '#e67a2a', '#2a1008', '#e67a2a', '#2a1008', '#8b3a0a', ''        ],
  ['',         '',         '#e67a2a', '#2a1008', '#8b3a0a', '',         ''        ],
  ['',         '',         '',         '#2a1008', '',         '',         ''        ],
] as const;
