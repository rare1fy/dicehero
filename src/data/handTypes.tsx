...
export const HAND_TYPES: HandTypeDef[] = [
  ...
  { id: 'same_element', name: '同元素', icon: <PixelDroplet size={2} />, base: 25, mult: 3.5, description: '至少4颗元素相同的骰子。伤害 = (14 + 总点数) × 2.5，附加2层中毒。' },
  ...
  { id: 'element_straight', name: '元素顺', icon: <PixelZap size={2} />, base: 50, mult: 6.0, description: '同元素 + 顺子。伤害 = (35 + 总点数) × 4.5，获得20点护甲，附加5层中毒。' },
  { id: 'element_house', name: '元素葫芦', icon: <PixelWaves size={2} />, base: 55, mult: 6.5, description: '同元素 + 葫芦。伤害 = (40 + 总点数) × 5.0，获得30点护甲，附加8层中毒。' },
  { id: 'royal_element', name: '皇家元素顺', icon: <PixelCrown size={2} />, base: 80, mult: 10.0, description: '同元素 + 顺子(1-6)。伤害 = (60 + 总点数) × 7.0，获得50点护甲，附加15层中毒。' },
];
