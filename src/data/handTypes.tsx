...
export const HAND_TYPES: HandTypeDef[] = [
  ...
  { id: 'three_of_a_kind', name: '三条', icon: <PixelTriangle size={2} />, base: 0, mult: 3.5, description: '3颗点数相同。伤害 = 点数和 x 3.0，施加1层易伤(2回合)' },
  ...
  { id: 'four_of_a_kind', name: '四条', icon: <PixelSquare size={2} />, base: 0, mult: 6.0, description: '4颗点数相同。伤害 = 点数和 x 5.0，施加2层易伤(2回合)' },
  ...
  { id: 'five_of_a_kind', name: '五条', icon: <PixelStar size={2} />, base: 0, mult: 9.0, description: '5颗点数相同。伤害 = 点数和 x 7.0，施加3层易伤(2回合)' },
  { id: 'six_of_a_kind', name: '六条', icon: <PixelTrophy size={2} />, base: 0, mult: 15.0, description: '6颗点数相同。伤害 = 点数和 x 10.0，施加5层易伤(3回合)' },
  { id: 'royal_element', name: '皇家元素顺', icon: <PixelCrown size={2} />, base: 0, mult: 16.0, description: '同元素+顺子(1-6)。伤害 = 点数和 x 12.0，AOE全体，骰子效果x3+50护甲' },
];
