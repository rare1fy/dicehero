...
export const CLASS_DEFS: Record<ClassId, ClassDef> = {
  warrior: {
    ...
    passiveDesc: '【血怒战意】卖血重投每次+15%最终伤害（叠加）；血量<30%进入狂暴：伤害×1.3；普攻可多选骰子',
  ...
  mage: {
    ...
    passiveDesc: '【星界蓄力】未出牌骰子保留到下回合（4→5→6上限递增）；蓄力回合+6护甲；出牌后重置为4',
  ...
  rogue: {
    ...
    name: '盗贼',
    title: '暗影连击',
    description: '一回合出牌两次，连击加成层层递增。第一刀试探，第二刀致命。',
    color: '#30a050',
    colorLight: '#60d080',
    colorDark: '#104020',
    drawCount: 4,
    ...
    passiveDesc: '【连击】每回合出牌2次；第2次伤害×1.2；两次牌型不同+25%；第1次出牌弹回最小骰子',
    normalAttackMultiSelect: false,
  },
};
